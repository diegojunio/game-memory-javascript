 ...
 */
const cardImageUrl = "https://diegojunio.github.io/game-memory-javascript/src/images/cardboard/";
...
var soundFxCardShow = new Audio('https://diegojunio.github.io/game-memory-javascript/src/audio/hover.mp3');
var soundFxError = new Audio('https://diegojunio.github.io/game-memory-javascript/src/audio/error.mp3');
var soundFxMatch = new Audio('https://diegojunio.github.io/game-memory-javascript/src/audio/match.mp3');
cardsPairsAmount = 8;
let cardsMixed = [];
